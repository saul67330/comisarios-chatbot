...
export default function TopNavBar() {
  ...
  return (
    <nav className="fixed top-0 w-full z-50 bg-[#131313]/90 backdrop-blur-xl flex justify-between items-center px-4 md:px-8 py-4 shadow-[0_20px_50px_rgba(19,19,19,0.8)]">
      <div className="flex items-center gap-4">
        <Link href="/" className="flex items-center gap-2 md:gap-3">
          <div className="w-8 h-8 md:w-10 md:h-10 rounded-full border border-primary/50 shadow-[0_0_15px_rgba(212,175,55,0.4)] overflow-hidden shrink-0 bg-black">
            <img 
          ...
          <span className="text-base sm:text-lg md:text-2xl font-bold text-[#D4AF37] font-['Rye'] tracking-tight sm:tracking-normal md:tracking-widest hover:opacity-80 transition-opacity whitespace-nowrap drop-shadow-md">COMISARIOS DEL NORTE</span>
        </Link>
